...
for k=1:size(dfile,1)
    ...
    %convert to Matlab times
    dmatnum = ones(size(dnum)).*datenum('30-Dec-1899')+dnum;
...
PlotPrecision = P_prec.*100;
PlotRecall = P_rec.*100;
figure(1)
